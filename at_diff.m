...
h=figure('Color','w','Position',[200 200 1000 500]);
...
for j=1:length(statarr)
    ...
    %if j==1
        Traj(rec,'Color',colind,'colorindex',cindex,'tag',['Cell type:' strarr{j} '-' num2str(ii)],h,'width',cellwidth,'startX',startX,'startY',startY,'sepColor',[1 1 1],'sepwidth',1,'gradientWidth',0);
    %end
end
