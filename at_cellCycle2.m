      ...
      % edit synthetic:
       ...
       % mine+tc.detectionFrame-1,maxe+tc.detectionFrame-1
        ...
        [areaM,areaB,areaN,volume]=computeVolume(mine+tc.detectionFrame-1,maxe+tc.detectionFrame-1,tc,tdau,frame,mine); % areaM and B have the same size as fl
            ...
            disp(['unknow bug with computeVolume: skipping cell...']);
            continue
        end
        % volume
...
includeAna2Cytokinesis=2.4; % in case the timing between anaphase and cytokinesis should be taken into account
